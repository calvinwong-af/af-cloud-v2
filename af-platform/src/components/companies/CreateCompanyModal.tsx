...
import type { CreateCompanyInput } from '@/lib/companies-write';
...
export function CreateCompanyModal({ open, onClose, onCreated }: CreateCompanyModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--border)]">
          <h2 className="text-lg font-semibold text-[var(--text)]">Create New Company</h2>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="Company Name *">
              <input
                ...
                placeholder="AcceleFreight Sdn Bhd"
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Field label="Currency">
              <select
                value={form.preferred_currency ?? 'MYR'}
